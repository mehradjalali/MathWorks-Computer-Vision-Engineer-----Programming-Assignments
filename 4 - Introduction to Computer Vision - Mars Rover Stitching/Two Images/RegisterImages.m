...
% Auto-generated by registrationEstimator app on 13-Aug-2025
%-----------------------------------------------------------
...
fixedPoints = detectSURFFeatures(FIXED,'MetricThreshold',606.250000,'NumOctaves',3,'NumScaleLevels',5);
movingPoints = detectSURFFeatures(MOVING,'MetricThreshold',606.250000,'NumOctaves',3,'NumScaleLevels',5);
...
% Match features
indexPairs = matchFeatures(fixedFeatures,movingFeatures,'MatchThreshold',42.500000,'MaxRatio',0.425000);
